...
def print_config_tree(
    ...
    Args:
        ...
        print_order: Determines in what order config components are printed.
            Default is ``("data", "model", "callbacks", "logger", "trainer",
            "paths", "extras")``.
        resolve: Whether to resolve reference fields of DictConfig. Default is
            ``False``.
...
def enforce_tags(cfg: DictConfig, save_to_file: bool = False) -> None:
    ...
    Args:
        cfg: A DictConfig composed by Hydra.
        save_to_file: Whether to export tags to the hydra output folder. Default
            is ``False``.
    """
    if not cfg.get("tags"):
